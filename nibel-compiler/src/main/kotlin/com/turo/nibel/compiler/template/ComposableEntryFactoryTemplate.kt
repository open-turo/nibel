...
|                name = com.turo.nibel.runtime.buildRouteName($composableHolderName::class.qualifiedName!!, ${if (hasArgs) "destination.args" else "null"}),
|            )
|            return entry
|        }
${
...
|            val entry = $composableHolderName(
|                args = args,
|                name = com.turo.nibel.runtime.buildRouteName($composableHolderName::class.qualifiedName!!, args),
|            )
|            return entry
|        }
""".trimMargin("|")
...
|            val entry = $composableHolderName(
|                name = com.turo.nibel.runtime.buildRouteName($composableHolderName::class.qualifiedName!!, null),
|            )
|            return entry
|        }
""".trimMargin("|")
